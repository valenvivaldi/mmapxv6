...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 70 14 00 00 	mov    0x1470(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 44 14 00 00       	push   $0x1444
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 6b 14 00 00       	push   $0x146b
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 88 14 00 00       	push   $0x1488
     259:	6a 02                	push   $0x2
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 8b 14 00 00       	push   $0x148b
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 93 14 00 00       	push   $0x1493
     347:	6a 02                	push   $0x2
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 a1 14 00 00       	push   $0x14a1
     3ad:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 a5 14 00 00       	push   $0x14a5
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 c0 19 00 00       	push   $0x19c0
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 c0 19 00 00       	push   $0x19c0
     ...
     63c:	50                   	push   %eax
     63d:	68 c8 19 00 00       	push   $0x19c8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 c0 19 00 00       	push   $0x19c0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 c0 19 00 00       	push   $0x19c0
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 aa 14 00 00       	push   $0x14aa
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 c1 14 00 00       	push   $0x14c1
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 c3 14 00 00       	push   $0x14c3
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 c5 14 00 00       	push   $0x14c5
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 c7 14 00 00       	push   $0x14c7
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 e4 14 00 00       	push   $0x14e4
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 e7 14 00 00       	push   $0x14e7
    ...
    panic("parseblock");
     ...
     9c4:	68 e9 14 00 00       	push   $0x14e9
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 f4 14 00 00       	push   $0x14f4
    ...
    panic("syntax - missing )");
     ...
     a14:	68 f6 14 00 00       	push   $0x14f6
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 e7 14 00 00       	push   $0x14e7
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 ba 14 00 00       	push   $0x14ba
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 09 15 00 00       	push   $0x1509
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 17 15 00 00       	push   $0x1517
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 1c 15 00 00 	mov    0x151c(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     e04:	e8 14 01 00 00       	call   f1d <open>
...
00000ef5 <seek>:
SYSCALL(seek)
     ef5:	b8 1c 00 00 00       	mov    $0x1c,%eax
     efa:	cd 40                	int    $0x40
     efc:	c3                   	ret    
...
00000f7d <procstat>:
SYSCALL(procstat)
     f7d:	b8 16 00 00 00       	mov    $0x16,%eax
     f82:	cd 40                	int    $0x40
     f84:	c3                   	ret    

00000f85 <setpriority>:
SYSCALL(setpriority)
...
00000f9d <semdown>:
SYSCALL(semdown)
     f9d:	b8 1a 00 00 00       	mov    $0x1a,%eax
     fa2:	cd 40                	int    $0x40
     fa4:	c3                   	ret    

00000fa5 <semup>:
SYSCALL(semup)
     fa5:	b8 1b 00 00 00       	mov    $0x1b,%eax
     faa:	cd 40                	int    $0x40
     fac:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     fcd:	e8 2b ff ff ff       	call   efd <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1028:	0f b6 80 d0 19 00 00 	movzbl 0x19d0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1164:	75 25                	jne    118b <printf+0xff>
          s = "(null)";
    1166:	c7 45 f4 34 15 00 00 	movl   $0x1534,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    122c:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    12f7:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
}
    12fc:	90                   	nop
    12fd:	c9                   	leave  
    12fe:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    131e:	50                   	push   %eax
    131f:	e8 41 fc ff ff       	call   f65 <sbrk>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1374:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
    1379:	89 45 f0             	mov    %eax,-0x10(%ebp)
    137c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1380:	75 23                	jne    13a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1382:	c7 45 f0 64 1a 00 00 	movl   $0x1a64,-0x10(%ebp)
    1389:	8b 45 f0             	mov    -0x10(%ebp),%eax
    138c:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
    1391:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
    1396:	a3 64 1a 00 00       	mov    %eax,0x1a64
    base.s.size = 0;
    139b:	c7 05 68 1a 00 00 00 	movl   $0x0,0x1a68
    13a2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13f8:	a3 6c 1a 00 00       	mov    %eax,0x1a6c
      return (void*)(p + 1);
    ...
    if(p == freep)
    1405:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
