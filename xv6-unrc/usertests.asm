...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
      ...
      24:	e8 16 3f 00 00       	call   3f3f <mkdir>
  ...
  if(chdir("iputdir") < 0){
      ...
      53:	e8 ef 3e 00 00       	call   3f47 <chdir>
  ...
  if(unlink("../iputdir") < 0){
      ...
      82:	e8 a0 3e 00 00       	call   3f27 <unlink>
  ...
  if(chdir("/") < 0){
      ...
      b1:	e8 91 3e 00 00       	call   3f47 <chdir>
...
exitiputtest(void)
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     148:	e8 f2 3d 00 00       	call   3f3f <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     177:	e8 cb 3d 00 00       	call   3f47 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1a6:	e8 7c 3d 00 00       	call   3f27 <unlink>
...
openiputtest(void)
{
  ...
  if(mkdir("oidir") < 0){
     ...
     214:	e8 26 3d 00 00       	call   3f3f <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     274:	e8 9e 3c 00 00       	call   3f17 <open>
...
opentest(void)
{
  ...
  fd = open("echo", 0);
     ...
     325:	e8 ed 3b 00 00       	call   3f17 <open>
  ...
  close(fd);
     ...
     357:	e8 a3 3b 00 00       	call   3eff <close>
     35c:	83 c4 10             	add    $0x10,%esp
  fd = open("doesnotexist", 0);
     35f:	83 ec 08             	sub    $0x8,%esp
     362:	6a 00                	push   $0x0
     364:	68 9f 45 00 00       	push   $0x459f
     369:	e8 a9 3b 00 00       	call   3f17 <open>
...
writetest(void)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     3d7:	e8 3b 3b 00 00       	call   3f17 <open>
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     432:	e8 c0 3a 00 00       	call   3ef7 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     46a:	e8 88 3a 00 00       	call   3ef7 <write>
  ...
  close(fd);
     ...
     4bb:	e8 3f 3a 00 00       	call   3eff <close>
     4c0:	83 c4 10             	add    $0x10,%esp
  fd = open("small", O_RDONLY);
     4c3:	83 ec 08             	sub    $0x8,%esp
     4c6:	6a 00                	push   $0x0
     4c8:	68 e9 45 00 00       	push   $0x45e9
     4cd:	e8 45 3a 00 00       	call   3f17 <open>
  ...
  close(fd);
     ...
     551:	e8 a9 39 00 00       	call   3eff <close>
     556:	83 c4 10             	add    $0x10,%esp

  if(unlink("small") < 0){
     559:	83 ec 0c             	sub    $0xc,%esp
     55c:	68 e9 45 00 00       	push   $0x45e9
     561:	e8 c1 39 00 00       	call   3f27 <unlink>
...
writetest1(void)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     5e7:	e8 2b 39 00 00       	call   3f17 <open>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     636:	e8 bc 38 00 00       	call   3ef7 <write>
  ...
  close(fd);
     ...
     677:	e8 83 38 00 00       	call   3eff <close>
  ...
  fd = open("big", O_RDONLY);
     ...
     689:	e8 89 38 00 00       	call   3f17 <open>
  ...
  close(fd);
     ...
     76a:	e8 90 37 00 00       	call   3eff <close>
     76f:	83 c4 10             	add    $0x10,%esp
  if(unlink("big") < 0){
     772:	83 ec 0c             	sub    $0xc,%esp
     775:	68 20 47 00 00       	push   $0x4720
     77a:	e8 a8 37 00 00       	call   3f27 <unlink>
...
createtest(void)
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     805:	e8 0d 37 00 00       	call   3f17 <open>
     80a:	83 c4 10             	add    $0x10,%esp
     80d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    close(fd);
     810:	83 ec 0c             	sub    $0xc,%esp
     813:	ff 75 f0             	pushl  -0x10(%ebp)
     816:	e8 e4 36 00 00       	call   3eff <close>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     852:	e8 d0 36 00 00       	call   3f27 <unlink>
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
     ...
     8a1:	e8 99 36 00 00       	call   3f3f <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     8d0:	e8 72 36 00 00       	call   3f47 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     8ff:	e8 43 36 00 00       	call   3f47 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     92e:	e8 f4 35 00 00       	call   3f27 <unlink>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     997:	e8 73 35 00 00       	call   3f0f <exec>
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     a10:	50                   	push   %eax
     a11:	e8 e9 34 00 00       	call   3eff <close>
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a5d:	50                   	push   %eax
     a5e:	e8 94 34 00 00       	call   3ef7 <write>
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     aa3:	50                   	push   %eax
     aa4:	e8 56 34 00 00       	call   3eff <close>
    ...
    close(fds[0]);
     ...
     b6f:	50                   	push   %eax
     b70:	e8 8a 33 00 00       	call   3eff <close>
...
preempt(void)
{
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c05:	50                   	push   %eax
     c06:	e8 f4 32 00 00       	call   3eff <close>
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c1b:	50                   	push   %eax
     c1c:	e8 d6 32 00 00       	call   3ef7 <write>
    ...
    close(pfds[1]);
     ...
     c41:	50                   	push   %eax
     c42:	e8 b8 32 00 00       	call   3eff <close>
  ...
  close(pfds[1]);
     ...
     c52:	50                   	push   %eax
     c53:	e8 a7 32 00 00       	call   3eff <close>
  ...
  close(pfds[0]);
     ...
     c93:	50                   	push   %eax
     c94:	e8 66 32 00 00       	call   3eff <close>
...
mem(void)
{
  ...
  ppid = getpid();
     d9d:	e8 b5 31 00 00       	call   3f57 <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     e3c:	e8 c6 30 00 00       	call   3f07 <kill>
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f14:	e8 de 2f 00 00       	call   3ef7 <write>
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10a9:	e8 79 2e 00 00       	call   3f27 <unlink>
    ...
    10eb:	e8 27 2e 00 00       	call   3f17 <open>
    ...
    1148:	e8 aa 2d 00 00       	call   3ef7 <write>
  ...
  for(i = 0; i < 2; i++){
    ...
    11c9:	e8 49 2d 00 00       	call   3f17 <open>
  ...
  for(i = 0; i < 2; i++){
    ...
    124e:	e8 ac 2c 00 00       	call   3eff <close>
    ...
    127f:	e8 a3 2c 00 00       	call   3f27 <unlink>
...
createdelete(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    132a:	50                   	push   %eax
    132b:	e8 e7 2b 00 00       	call   3f17 <open>
    ...
    1359:	e8 a1 2b 00 00       	call   3eff <close>
    ...
    1389:	50                   	push   %eax
    138a:	e8 98 2b 00 00       	call   3f27 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    142a:	50                   	push   %eax
    142b:	e8 e7 2a 00 00       	call   3f17 <open>
    ...
    149c:	e8 5e 2a 00 00       	call   3eff <close>
  ...
  for(i = 0; i < N; i++){
    ...
    14ea:	50                   	push   %eax
    14eb:	e8 37 2a 00 00       	call   3f27 <unlink>
...
unlinkread(void)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1541:	e8 d1 29 00 00       	call   3f17 <open>
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1596:	e8 7c 29 00 00       	call   3f17 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c6:	e8 5c 29 00 00       	call   3f27 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15f6:	e8 1c 29 00 00       	call   3f17 <open>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1687:	e8 6b 28 00 00       	call   3ef7 <write>
...
linktest(void)
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    1723:	e8 ef 27 00 00       	call   3f17 <open>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1758:	e8 9a 27 00 00       	call   3ef7 <write>
  ...
  close(fd);
    ...
    1782:	e8 78 27 00 00       	call   3eff <close>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1797:	e8 9b 27 00 00       	call   3f37 <link>
  ...
  unlink("lf1");
    ...
    17c2:	e8 60 27 00 00       	call   3f27 <unlink>
  ...
  if(open("lf1", 0) >= 0){
    ...
    17d4:	e8 3e 27 00 00       	call   3f17 <open>
  ...
  fd = open("lf2", 0);
    ...
    1801:	e8 11 27 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    1863:	e8 97 26 00 00       	call   3eff <close>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    1878:	e8 ba 26 00 00       	call   3f37 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18e8:	e8 4a 26 00 00       	call   3f37 <link>
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    195b:	50                   	push   %eax
    195c:	e8 c6 25 00 00       	call   3f27 <unlink>
    ...
    19a0:	e8 92 25 00 00       	call   3f37 <link>
    ...
    19e4:	e8 4e 25 00 00       	call   3f37 <link>
    ...
    19f9:	50                   	push   %eax
    19fa:	e8 18 25 00 00       	call   3f17 <open>
    ...
    1a2c:	e8 ce 24 00 00       	call   3eff <close>
  ...
  fd = open(".", 0);
    ...
    1a6f:	e8 a3 24 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    1b3b:	e8 bf 23 00 00       	call   3eff <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    1bf3:	50                   	push   %eax
    1bf4:	e8 1e 23 00 00       	call   3f17 <open>
    1bf9:	83 c4 10             	add    $0x10,%esp
    1bfc:	83 ec 0c             	sub    $0xc,%esp
    1bff:	50                   	push   %eax
    1c00:	e8 fa 22 00 00       	call   3eff <close>
    ...
    1c10:	50                   	push   %eax
    1c11:	e8 01 23 00 00       	call   3f17 <open>
    1c16:	83 c4 10             	add    $0x10,%esp
    1c19:	83 ec 0c             	sub    $0xc,%esp
    1c1c:	50                   	push   %eax
    1c1d:	e8 dd 22 00 00       	call   3eff <close>
    ...
    1c2d:	50                   	push   %eax
    1c2e:	e8 e4 22 00 00       	call   3f17 <open>
    1c33:	83 c4 10             	add    $0x10,%esp
    1c36:	83 ec 0c             	sub    $0xc,%esp
    1c39:	50                   	push   %eax
    1c3a:	e8 c0 22 00 00       	call   3eff <close>
    ...
    1c4a:	50                   	push   %eax
    1c4b:	e8 c7 22 00 00       	call   3f17 <open>
    1c50:	83 c4 10             	add    $0x10,%esp
    1c53:	83 ec 0c             	sub    $0xc,%esp
    1c56:	50                   	push   %eax
    1c57:	e8 a3 22 00 00       	call   3eff <close>
...
linkunlink()
{
  ...
  unlink("x");
    ...
    1cf0:	e8 32 22 00 00       	call   3f27 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d7a:	e8 98 21 00 00       	call   3f17 <open>
    1d7f:	83 c4 10             	add    $0x10,%esp
    1d82:	83 ec 0c             	sub    $0xc,%esp
    1d85:	50                   	push   %eax
    1d86:	e8 74 21 00 00       	call   3eff <close>
    ...
    1dba:	e8 78 21 00 00       	call   3f37 <link>
    ...
    1dcc:	e8 56 21 00 00       	call   3f27 <unlink>
...
bigdir(void)
{
  ...
  unlink("bd");
    ...
    1e29:	e8 f9 20 00 00       	call   3f27 <unlink>
  ...
  fd = open("bd", O_CREATE);
    ...
    1e3e:	e8 d4 20 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    1e6c:	e8 8e 20 00 00       	call   3eff <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1eb9:	e8 79 20 00 00       	call   3f37 <link>
  ...
  unlink("bd");
    ...
    1ef1:	e8 31 20 00 00       	call   3f27 <unlink>
  ...
  for(i = 0; i < 500; i++){
    ...
    1f38:	50                   	push   %eax
    1f39:	e8 e9 1f 00 00       	call   3f27 <unlink>
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fde:	e8 34 1f 00 00       	call   3f17 <open>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    205c:	e8 de 1e 00 00       	call   3f3f <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    208c:	e8 86 1e 00 00       	call   3f17 <open>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20e1:	e8 31 1e 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    2152:	e8 a8 1d 00 00       	call   3eff <close>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2167:	e8 cb 1d 00 00       	call   3f37 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2192:	e8 90 1d 00 00       	call   3f27 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21bf:	e8 53 1d 00 00       	call   3f17 <open>
  ...
  if(chdir("dd") != 0){
    ...
    21ea:	e8 58 1d 00 00       	call   3f47 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2215:	e8 2d 1d 00 00       	call   3f47 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2240:	e8 02 1d 00 00       	call   3f47 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    226b:	e8 d7 1c 00 00       	call   3f47 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2298:	e8 7a 1c 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    22fa:	e8 00 1c 00 00       	call   3eff <close>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    230c:	e8 06 1c 00 00       	call   3f17 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    233c:	e8 d6 1b 00 00       	call   3f17 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    236c:	e8 a6 1b 00 00       	call   3f17 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    239c:	e8 76 1b 00 00       	call   3f17 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23c9:	e8 49 1b 00 00       	call   3f17 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    23f6:	e8 1c 1b 00 00       	call   3f17 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2426:	e8 0c 1b 00 00       	call   3f37 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2456:	e8 dc 1a 00 00       	call   3f37 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2486:	e8 ac 1a 00 00       	call   3f37 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24b1:	e8 89 1a 00 00       	call   3f3f <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24dc:	e8 5e 1a 00 00       	call   3f3f <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2507:	e8 33 1a 00 00       	call   3f3f <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2532:	e8 f0 19 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    255d:	e8 c5 19 00 00       	call   3f27 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2588:	e8 ba 19 00 00       	call   3f47 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25b3:	e8 8f 19 00 00       	call   3f47 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25de:	e8 44 19 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2609:	e8 19 19 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2634:	e8 ee 18 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    265f:	e8 c3 18 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    268a:	e8 98 18 00 00       	call   3f27 <unlink>
...
bigwrite(void)
{
  ...
  unlink("bigwrite");
    ...
    26e2:	e8 40 18 00 00       	call   3f27 <unlink>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2703:	e8 0f 18 00 00       	call   3f17 <open>
    ...
    2742:	e8 b0 17 00 00       	call   3ef7 <write>
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    284e:	e8 a4 16 00 00       	call   3ef7 <write>
  ...
  close(fd);
    ...
    2884:	e8 76 16 00 00       	call   3eff <close>
  ...
  fd = open("bigfile", 0);
    ...
    2896:	e8 7c 16 00 00       	call   3f17 <open>
  ...
  close(fd);
    ...
    298b:	e8 6f 15 00 00       	call   3eff <close>
  ...
  unlink("bigfile");
    ...
    29bb:	e8 67 15 00 00       	call   3f27 <unlink>
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    29f8:	e8 42 15 00 00       	call   3f3f <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a23:	e8 17 15 00 00       	call   3f3f <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a53:	e8 bf 14 00 00       	call   3f17 <open>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2afc:	e8 3e 14 00 00       	call   3f3f <mkdir>
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2b54:	e8 e6 13 00 00       	call   3f3f <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2b7f:	e8 c3 13 00 00       	call   3f47 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2baa:	e8 78 13 00 00       	call   3f27 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2bd5:	e8 4d 13 00 00       	call   3f27 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2c00:	e8 42 13 00 00       	call   3f47 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c2b:	e8 f7 12 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c56:	e8 cc 12 00 00       	call   3f27 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2c81:	e8 a1 12 00 00       	call   3f27 <unlink>
...
dirfile(void)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2cde:	e8 34 12 00 00       	call   3f17 <open>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d49:	e8 c9 11 00 00       	call   3f17 <open>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d7e:	e8 94 11 00 00       	call   3f17 <open>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2dae:	e8 8c 11 00 00       	call   3f3f <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2dd9:	e8 49 11 00 00       	call   3f27 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e09:	e8 29 11 00 00       	call   3f37 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e34:	e8 ee 10 00 00       	call   3f27 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2e61:	e8 b1 10 00 00       	call   3f17 <open>
  ...
  fd = open(".", 0);
    ...
    2e93:	e8 7f 10 00 00       	call   3f17 <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eab:	e8 47 10 00 00       	call   3ef7 <write>
  ...
  close(fd);
    ...
    2ed4:	e8 26 10 00 00       	call   3eff <close>
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f1d:	e8 1d 10 00 00       	call   3f3f <mkdir>
    ...
    2f48:	e8 fa 0f 00 00       	call   3f47 <chdir>
  ...
  chdir("/");
    ...
    300e:	e8 34 0f 00 00       	call   3f47 <chdir>
...
sbrktest(void)
{
  ...
  oldbrk = sbrk(0);
    ...
    3115:	6a 00                	push   $0x0
    3117:	e8 43 0e 00 00       	call   3f5f <sbrk>
  ...
  a = sbrk(0);
    ...
    3125:	6a 00                	push   $0x0
    3127:	e8 33 0e 00 00       	call   3f5f <sbrk>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    313e:	6a 01                	push   $0x1
    3140:	e8 1a 0e 00 00       	call   3f5f <sbrk>
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    3215:	6a 00                	push   $0x0
    3217:	e8 43 0d 00 00       	call   3f5f <sbrk>
  ...
  p = sbrk(amt);
    ...
    3237:	50                   	push   %eax
    3238:	e8 22 0d 00 00       	call   3f5f <sbrk>
  ...
  *lastaddr = 99;
  ...
  c = sbrk(0);
    ...
    32ba:	6a 00                	push   $0x0
    32bc:	e8 9e 0c 00 00       	call   3f5f <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3320:	6a 00                	push   $0x0
    3322:	e8 38 0c 00 00       	call   3f5f <sbrk>
  ...
  a = sbrk(0);
    ...
    337e:	6a 00                	push   $0x0
    3380:	e8 da 0b 00 00       	call   3f5f <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    33dd:	e8 75 0b 00 00       	call   3f57 <getpid>
    ...
    343a:	e8 c8 0a 00 00       	call   3f07 <kill>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34ae:	6a 00                	push   $0x0
    34b0:	e8 aa 0a 00 00       	call   3f5f <sbrk>
    ...
    34c4:	50                   	push   %eax
    34c5:	e8 95 0a 00 00       	call   3f5f <sbrk>
  ...
  c = sbrk(4096);
    ...
    352e:	e8 2c 0a 00 00       	call   3f5f <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3558:	50                   	push   %eax
    3559:	e8 a9 09 00 00       	call   3f07 <kill>
  ...
  if(sbrk(0) > oldbrk)
    ...
    3599:	6a 00                	push   $0x0
    359b:	e8 bf 09 00 00       	call   3f5f <sbrk>
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3691:	e8 a1 08 00 00       	call   3f37 <link>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3769:	e8 b9 07 00 00       	call   3f27 <unlink>
  ...
  if(pid == 0){
    ...
    37d1:	e8 39 07 00 00       	call   3f0f <exec>
  ...
  fd = open("bigarg-ok", 0);
    ...
    384a:	e8 c8 06 00 00       	call   3f17 <open>
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    39a7:	50                   	push   %eax
    39a8:	e8 6a 05 00 00       	call   3f17 <open>
    ...
    39e8:	e8 0a 05 00 00       	call   3ef7 <write>
    ...
    3a24:	e8 d6 04 00 00       	call   3eff <close>
  ...
  while(nfiles >= 0){
    ...
    3b0f:	50                   	push   %eax
    3b10:	e8 12 04 00 00       	call   3f27 <unlink>
...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3b8a:	e8 88 03 00 00       	call   3f17 <open>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3bba:	e8 58 03 00 00       	call   3f17 <open>
    3bbf:	83 c4 10             	add    $0x10,%esp
    3bc2:	83 ec 0c             	sub    $0xc,%esp
    3bc5:	50                   	push   %eax
    3bc6:	e8 34 03 00 00       	call   3eff <close>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3dfe:	e8 14 01 00 00       	call   3f17 <open>
...
00003eef <seek>:
SYSCALL(seek)
    3eef:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3ef4:	cd 40                	int    $0x40
    3ef6:	c3                   	ret    

00003ef7 <write>:
SYSCALL(write)
    3ef7:	b8 10 00 00 00       	mov    $0x10,%eax
    3efc:	cd 40                	int    $0x40
    3efe:	c3                   	ret    

00003eff <close>:
SYSCALL(close)
    3eff:	b8 15 00 00 00       	mov    $0x15,%eax
    3f04:	cd 40                	int    $0x40
    3f06:	c3                   	ret    

00003f07 <kill>:
SYSCALL(kill)
    3f07:	b8 06 00 00 00       	mov    $0x6,%eax
    3f0c:	cd 40                	int    $0x40
    3f0e:	c3                   	ret    

00003f0f <exec>:
SYSCALL(exec)
    3f0f:	b8 07 00 00 00       	mov    $0x7,%eax
    3f14:	cd 40                	int    $0x40
    3f16:	c3                   	ret    

00003f17 <open>:
SYSCALL(open)
    3f17:	b8 0f 00 00 00       	mov    $0xf,%eax
    3f1c:	cd 40                	int    $0x40
    3f1e:	c3                   	ret    

00003f1f <mknod>:
SYSCALL(mknod)
    3f1f:	b8 11 00 00 00       	mov    $0x11,%eax
    3f24:	cd 40                	int    $0x40
    3f26:	c3                   	ret    

00003f27 <unlink>:
SYSCALL(unlink)
    3f27:	b8 12 00 00 00       	mov    $0x12,%eax
    3f2c:	cd 40                	int    $0x40
    3f2e:	c3                   	ret    

00003f2f <fstat>:
SYSCALL(fstat)
    3f2f:	b8 08 00 00 00       	mov    $0x8,%eax
    3f34:	cd 40                	int    $0x40
    3f36:	c3                   	ret    

00003f37 <link>:
SYSCALL(link)
    3f37:	b8 13 00 00 00       	mov    $0x13,%eax
    3f3c:	cd 40                	int    $0x40
    3f3e:	c3                   	ret    

00003f3f <mkdir>:
SYSCALL(mkdir)
    3f3f:	b8 14 00 00 00       	mov    $0x14,%eax
    3f44:	cd 40                	int    $0x40
    3f46:	c3                   	ret    

00003f47 <chdir>:
SYSCALL(chdir)
    3f47:	b8 09 00 00 00       	mov    $0x9,%eax
    3f4c:	cd 40                	int    $0x40
    3f4e:	c3                   	ret    

00003f4f <dup>:
SYSCALL(dup)
    3f4f:	b8 0a 00 00 00       	mov    $0xa,%eax
    3f54:	cd 40                	int    $0x40
    3f56:	c3                   	ret    

00003f57 <getpid>:
SYSCALL(getpid)
    3f57:	b8 0b 00 00 00       	mov    $0xb,%eax
    3f5c:	cd 40                	int    $0x40
    3f5e:	c3                   	ret    

00003f5f <sbrk>:
SYSCALL(sbrk)
    3f5f:	b8 0c 00 00 00       	mov    $0xc,%eax
    3f64:	cd 40                	int    $0x40
    3f66:	c3                   	ret    

00003f67 <sleep>:
SYSCALL(sleep)
    3f67:	b8 0d 00 00 00       	mov    $0xd,%eax
    3f6c:	cd 40                	int    $0x40
    3f6e:	c3                   	ret    

00003f6f <uptime>:
SYSCALL(uptime)
    3f6f:	b8 0e 00 00 00       	mov    $0xe,%eax
    3f74:	cd 40                	int    $0x40
    3f76:	c3                   	ret    

00003f77 <procstat>:
SYSCALL(procstat)
    3f77:	b8 16 00 00 00       	mov    $0x16,%eax
    3f7c:	cd 40                	int    $0x40
    3f7e:	c3                   	ret    

00003f7f <setpriority>:
SYSCALL(setpriority)
...
00003f87 <semget>:
SYSCALL(semget)
    3f87:	b8 18 00 00 00       	mov    $0x18,%eax
    3f8c:	cd 40                	int    $0x40
    3f8e:	c3                   	ret    

00003f8f <semfree>:
SYSCALL(semfree)
    3f8f:	b8 19 00 00 00       	mov    $0x19,%eax
    3f94:	cd 40                	int    $0x40
    3f96:	c3                   	ret    

00003f97 <semdown>:
SYSCALL(semdown)
    3f97:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3f9c:	cd 40                	int    $0x40
    3f9e:	c3                   	ret    

00003f9f <semup>:
SYSCALL(semup)
    3f9f:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3fa4:	cd 40                	int    $0x40
    3fa6:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    3fc7:	e8 2b ff ff ff       	call   3ef7 <write>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4318:	50                   	push   %eax
    4319:	e8 41 fc ff ff       	call   3f5f <sbrk>
