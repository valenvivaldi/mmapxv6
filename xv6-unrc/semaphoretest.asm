...
enqueue()
{
  ...
  semdown(semb);
  2f:	a1 6c 08 00 00       	mov    0x86c,%eax
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	50                   	push   %eax
  38:	e8 5c 05 00 00       	call   599 <semdown>
  3d:	83 c4 10             	add    $0x10,%esp
  write(fd, "+1", sizeof("+1"));
  40:	a1 68 08 00 00       	mov    0x868,%eax
  45:	83 ec 04             	sub    $0x4,%esp
  48:	6a 03                	push   $0x3
  4a:	68 b1 05 00 00       	push   $0x5b1
  4f:	50                   	push   %eax
  50:	e8 a4 04 00 00       	call   4f9 <write>
  55:	83 c4 10             	add    $0x10,%esp
  semup(semb);
  58:	a1 6c 08 00 00       	mov    0x86c,%eax
...
unqueue()
{
  ...
  semdown(semb);
  72:	a1 6c 08 00 00       	mov    0x86c,%eax
  77:	83 ec 0c             	sub    $0xc,%esp
  7a:	50                   	push   %eax
  7b:	e8 19 05 00 00       	call   599 <semdown>
  80:	83 c4 10             	add    $0x10,%esp
  write(fd, "-1", sizeof("-1"));
  83:	a1 68 08 00 00       	mov    0x868,%eax
  88:	83 ec 04             	sub    $0x4,%esp
  8b:	6a 03                	push   $0x3
  8d:	68 b4 05 00 00       	push   $0x5b4
  92:	50                   	push   %eax
  93:	e8 61 04 00 00       	call   4f9 <write>
  98:	83 c4 10             	add    $0x10,%esp
  semup(semb);
  9b:	a1 6c 08 00 00       	mov    0x86c,%eax
...
cons()
{
  ...
  for(;;) {
    semdown(semempty);
  b9:	a1 70 08 00 00       	mov    0x870,%eax
  ...
  ca:	e8 9d ff ff ff       	call   6c <unqueue>
    semup(semfull);
  cf:	a1 74 08 00 00       	mov    0x874,%eax
...
prod()
{
  ...
  ef:	eb 2b                	jmp    11c <prod+0x3a>
      semdown(semfull);
  f1:	a1 74 08 00 00       	mov    0x874,%eax
 ...
 102:	e8 22 ff ff ff       	call   29 <enqueue>
      semup(semempty);
 107:	a1 70 08 00 00       	mov    0x870,%eax
...
semtest(void)
{
 ...
 13a:	68 b7 05 00 00       	push   $0x5b7
 13f:	e8 d5 03 00 00       	call   519 <open>
 144:	83 c4 10             	add    $0x10,%esp
 147:	a3 68 08 00 00       	mov    %eax,0x868
...
main(void)
{
 ...
 20d:	a3 70 08 00 00       	mov    %eax,0x870
  printf(1,"despues de semget semempty\n" );
 212:	83 ec 08             	sub    $0x8,%esp
 215:	68 d7 05 00 00       	push   $0x5d7
 21a:	6a 01                	push   $0x1
 ...
 233:	a3 74 08 00 00       	mov    %eax,0x874
  printf(1,"despues de semget semfull\n" );
 238:	83 ec 08             	sub    $0x8,%esp
 23b:	68 f3 05 00 00       	push   $0x5f3
 240:	6a 01                	push   $0x1
 ...
 259:	a3 6c 08 00 00       	mov    %eax,0x86c
  printf(1,"despues de semget semb\n" );
 25e:	83 ec 08             	sub    $0x8,%esp
 261:	68 0e 06 00 00       	push   $0x60e
 266:	6a 01                	push   $0x1
