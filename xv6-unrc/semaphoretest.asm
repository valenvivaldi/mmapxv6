...
printf(int fd, char *s, ...)
{
  ...
  1e:	e8 d6 04 00 00       	call   4f9 <write>
...
enqueue()
{
  ...
  semdown(semb);
  2f:	a1 74 08 00 00       	mov    0x874,%eax
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	50                   	push   %eax
  38:	e8 5c 05 00 00       	call   599 <semdown>
  3d:	83 c4 10             	add    $0x10,%esp
  write(fd, "+1", sizeof("+1"));
  40:	a1 70 08 00 00       	mov    0x870,%eax
  45:	83 ec 04             	sub    $0x4,%esp
  48:	6a 03                	push   $0x3
  4a:	68 b9 05 00 00       	push   $0x5b9
  4f:	50                   	push   %eax
  50:	e8 a4 04 00 00       	call   4f9 <write>
  55:	83 c4 10             	add    $0x10,%esp
  semup(semb);
  58:	a1 74 08 00 00       	mov    0x874,%eax
  5d:	83 ec 0c             	sub    $0xc,%esp
  60:	50                   	push   %eax
  61:	e8 3b 05 00 00       	call   5a1 <semup>
...
unqueue()
{
  ...
  semdown(semb);
  72:	a1 74 08 00 00       	mov    0x874,%eax
  77:	83 ec 0c             	sub    $0xc,%esp
  7a:	50                   	push   %eax
  7b:	e8 19 05 00 00       	call   599 <semdown>
  80:	83 c4 10             	add    $0x10,%esp
  write(fd, "-1", sizeof("-1"));
  83:	a1 70 08 00 00       	mov    0x870,%eax
  88:	83 ec 04             	sub    $0x4,%esp
  8b:	6a 03                	push   $0x3
  8d:	68 bc 05 00 00       	push   $0x5bc
  92:	50                   	push   %eax
  93:	e8 61 04 00 00       	call   4f9 <write>
  98:	83 c4 10             	add    $0x10,%esp
  semup(semb);
  9b:	a1 74 08 00 00       	mov    0x874,%eax
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	50                   	push   %eax
  a4:	e8 f8 04 00 00       	call   5a1 <semup>
...
cons()
{
  ...
  for(;;) {
    semdown(semempty);
  b9:	a1 78 08 00 00       	mov    0x878,%eax
  be:	83 ec 0c             	sub    $0xc,%esp
  c1:	50                   	push   %eax
  c2:	e8 d2 04 00 00       	call   599 <semdown>
  c7:	83 c4 10             	add    $0x10,%esp
    unqueue();
  ca:	e8 9d ff ff ff       	call   6c <unqueue>
    semup(semfull);
  cf:	a1 7c 08 00 00       	mov    0x87c,%eax
  d4:	83 ec 0c             	sub    $0xc,%esp
  d7:	50                   	push   %eax
  d8:	e8 c4 04 00 00       	call   5a1 <semup>
...
prod()
{
  ...
  ef:	eb 2b                	jmp    11c <prod+0x3a>
      semdown(semfull);
  f1:	a1 7c 08 00 00       	mov    0x87c,%eax
  f6:	83 ec 0c             	sub    $0xc,%esp
  f9:	50                   	push   %eax
  fa:	e8 9a 04 00 00       	call   599 <semdown>
  ff:	83 c4 10             	add    $0x10,%esp
      enqueue();
 102:	e8 22 ff ff ff       	call   29 <enqueue>
      semup(semempty);
 107:	a1 78 08 00 00       	mov    0x878,%eax
 10c:	83 ec 0c             	sub    $0xc,%esp
 10f:	50                   	push   %eax
 110:	e8 8c 04 00 00       	call   5a1 <semup>
...
semtest(void)
{
 ...
 13a:	68 bf 05 00 00       	push   $0x5bf
 13f:	e8 d5 03 00 00       	call   519 <open>
 144:	83 c4 10             	add    $0x10,%esp
 147:	a3 70 08 00 00       	mov    %eax,0x870
...
main(void)
{
 ...
 205:	e8 7f 03 00 00       	call   589 <semget>
 20a:	83 c4 10             	add    $0x10,%esp
 20d:	a3 78 08 00 00       	mov    %eax,0x878
  printf(1,"despues de semget semempty\n" );
 212:	83 ec 08             	sub    $0x8,%esp
 215:	68 df 05 00 00       	push   $0x5df
 21a:	6a 01                	push   $0x1
 ...
 22b:	e8 59 03 00 00       	call   589 <semget>
 230:	83 c4 10             	add    $0x10,%esp
 233:	a3 7c 08 00 00       	mov    %eax,0x87c
  printf(1,"despues de semget semfull\n" );
 238:	83 ec 08             	sub    $0x8,%esp
 23b:	68 fb 05 00 00       	push   $0x5fb
 240:	6a 01                	push   $0x1
 ...
 251:	e8 33 03 00 00       	call   589 <semget>
 256:	83 c4 10             	add    $0x10,%esp
 259:	a3 74 08 00 00       	mov    %eax,0x874
  printf(1,"despues de semget semb\n" );
 25e:	83 ec 08             	sub    $0x8,%esp
 261:	68 16 06 00 00       	push   $0x616
 266:	6a 01                	push   $0x1
...
stat(char *n, struct stat *st)
{
 ...
 400:	e8 14 01 00 00       	call   519 <open>
...
00000591 <semfree>:
SYSCALL(semfree)
 591:	b8 19 00 00 00       	mov    $0x19,%eax
 596:	cd 40                	int    $0x40
 598:	c3                   	ret    

00000599 <semdown>:
SYSCALL(semdown)
 599:	b8 1a 00 00 00       	mov    $0x1a,%eax
 59e:	cd 40                	int    $0x40
 5a0:	c3                   	ret    

000005a1 <semup>:
SYSCALL(semup)
 5a1:	b8 1b 00 00 00       	mov    $0x1b,%eax
 5a6:	cd 40                	int    $0x40
 5a8:	c3                   	ret    
...
000005b1 <munmap>:
SYSCALL(munmap)
 5b1:	b8 1e 00 00 00       	mov    $0x1e,%eax
 5b6:	cd 40                	int    $0x40
 5b8:	c3                   	ret    
