...
putc(int fd, char c)
{
 ...
 682:	e8 23 ff ff ff       	call   5aa <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6dd:	0f b6 80 04 0e 00 00 	movzbl 0xe04(%eax),%eax
...
free(void *ap)
{
 ...
 8e1:	a1 28 0e 00 00       	mov    0xe28,%eax
...
free(void *ap)
{
 ...
 9ac:	a3 28 0e 00 00       	mov    %eax,0xe28
}
 9b1:	90                   	nop
 9b2:	c9                   	leave  
 9b3:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 9d3:	50                   	push   %eax
 9d4:	e8 39 fc ff ff       	call   612 <sbrk>
 ...
 a0a:	83 c4 10             	add    $0x10,%esp
  return freep;
 a0d:	a1 28 0e 00 00       	mov    0xe28,%eax
}
 a12:	c9                   	leave  
 a13:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a37:	c7 45 f0 20 0e 00 00 	movl   $0xe20,-0x10(%ebp)
 a3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a41:	a3 28 0e 00 00       	mov    %eax,0xe28
 a46:	a1 28 0e 00 00       	mov    0xe28,%eax
 a4b:	a3 20 0e 00 00       	mov    %eax,0xe20
    base.s.size = 0;
 a50:	c7 05 24 0e 00 00 00 	movl   $0x0,0xe24
 a57:	00 00 00 
  }
 ...
 aad:	a3 28 0e 00 00       	mov    %eax,0xe28
      return (void*)(p + 1);
 ...
 ab8:	eb 3b                	jmp    af5 <malloc+0xe1>
    ...
    if(p == freep)
 aba:	a1 28 0e 00 00       	mov    0xe28,%eax
